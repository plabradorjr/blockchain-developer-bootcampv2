...
describe("Token", () => {
  ...
  beforeEach(async () => {
    ...
    token = await Token.deploy("Pengu Token", "PENGU", "1000000");
  ...
  describe("Sending Tokens", () => {
    ...
    describe("Failure", () => {
      it("rejects insufficient balances", async () => {
        ...
        const invalidAmount = tokens(10000000000000000);
        await expect(
  ...
  describe("Delegated Token Transfers", () => {
    ...
    describe("Failure", () => {
      ...
      it("reverts invalid amount for delegated transfer", async () => {
        await expect(
          token
            .connect(exchange)
